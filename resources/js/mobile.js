...
function print_task(id, name, description, due_date, progress, subtask_of_id, reminder) {
    ...
    const toAppend = "<div class='task' id='task_" + String(id) + "'><li>"
        +   "<div class='controlButtons taskSeperator'><button onclick='complete_task(" + id + ")' class='taskbtn'>✅</button><button class='editBtn taskbtn' onclick='edit_task(" + id + ")'>✎️</button><button onclick='delete_task(" + String(id) + ")' class='taskbtn'>🗑️</button>"
