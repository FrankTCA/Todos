...
require "creds.php";
validate_token("https://infotoast.org/todos/index.php");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Info Toast To-Dos</title>
...
<div class="theBody">
    <div class="iconBodyHeader"  id="pastDueHeader">
        <h2>‼️Past Due</h2>
    </div>
    <div class="taskSet" id="pastDue">
        <table id="pastDueTable">
    ...
    <div class="iconBodyHeader" id="currentHeader">
        <h2>🗓️Current</h2>
    </div>
    <div class="taskSet" id="current">
    ...
    <div class="iconBodyHeader" id="doneHeader">
        <h2>🟢Done</h2>
    </div>
    <div class="taskSet" id="done">
        <table id="doneTable">
            <tr class="tableHeader">
                <th>Name</th>
                <th>Description</th>
